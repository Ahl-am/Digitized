...
<form name="myForm" onsubmit="return validateLoginForm()"  method="POST" action="user.php?q=inst_login">
<h2>	<strong class="mark">Instructor Log-in</strong></h2>
  <!--Name:<br><input type="text" name="fname">
  <br>-->
  <br>
  Email<br><br>
  <input type="email" class="form" name="email" placeholder="Maha@gmail.com">
  <br>
  Password<br><br>
  <input type="password" class="form" name="password" value="1234">
  <br>
